...
trainingdata_numbers <- cbind(churn=targets$churn, trainingdata_numbers)

#imputes the training data 
trainingdata_numbers_impute <- mlr::impute(trainingdata_numbers, target = "churn", classes = list(numeric = imputeNormal()))
...
save.image(file = 'Churn_Step_1_Initial_Preprocessing.RData')
