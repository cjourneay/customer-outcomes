...
############################# run k-means on the churn data sets

k_means_results <- k_means_transform("churn", "NA_Transform", trainingdata_Factor_None_Transform, testdata_Factor_None_Transform)

write.table(k_means_results$k_means_training, sep="\t", na = "" ,  file = "churn_Step_2B_train_Factor_None_Transform_k_means.csv", row.names = FALSE)
write.table(k_means_results$k_means_test, sep="\t", na = "",  file = "churn_Step_2B_test_Factor_None_Transform_k_means.csv", row.names = FALSE)

####### run the transformation on the NA Mode imputed factor data set

k_means_results <- k_means_transform("churn", "Mode_Transform", trainingdata_Factor_Mode_Transform, testdata_Factor_Mode_Transform)

write.table(k_means_results$k_means_training, sep="\t", na = "" ,  file = "churn_Step_2B_train_Factor_Mode_Transform_k_means.csv", row.names = FALSE)
write.table(k_means_results$k_means_test, sep="\t", na = "",  file = "churn_Step_2B_test_Factor_Mode_Transform_k_means.csv", row.names = FALSE)
...
save.image(file = "Churn_Step_2B_factor_k_means_bin.RData")
