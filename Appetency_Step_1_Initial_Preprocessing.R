...
trainingdata_numbers <- cbind(appetency=targets$appetency, trainingdata_numbers)

#imputes the training data 
trainingdata_numbers_impute <- mlr::impute(trainingdata_numbers, target = "appetency", classes = list(numeric = imputeNormal()))
...
save.image(file = 'Appetency_Step_1_Initial_Preprocessing.RData')
